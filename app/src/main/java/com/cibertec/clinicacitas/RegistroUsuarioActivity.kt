...
class RegistroUsuarioActivity : AppCompatActivity() {
    ...
    private fun setupRoleSelectionListener() {
        binding.spRol.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                // CORREGIDO: "Médico" con tilde para que coincida con strings.xml
    ...
    private fun performValidationAndSave() {
        ...
        val newUser = Usuario(id = 0, username = username, password = password, role = selectedRole)
        val newUserId = usuarioDAO.registrarUsuario(newUser)
